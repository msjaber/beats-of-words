...
var Languages = {
  all: function() {
    return this.arabic.concat(this.english, this.spanish);
  },
  arabic: ['كلمات','حروف','ُحب','ضوء','حياة','جمال','عربية','كلمة','شغف','اقرأ','قلم','قمر','قهوة','روح','سماء','ورد'],
...
var Heart = {
  ...
  changeLanguageTo: function(chosenLanguage) {
    ...
    if (chosenLanguage == 'all') {
      ...
      // allLanguages = Languages.arabic.concat(Languages.english, Languages.spanish);
      // this.configures.language = allLanguages;
